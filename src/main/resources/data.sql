...
VALUES (1, '홍길동', 'hong@gmail.com', '010-1111-1111', '2000-01-01', 'MALE', NOW(), NOW()),
       (2, '이은채', 'eun@gmail.com', '010-2222-2222', '2004-11-03', 'FEMALE', NOW(), NOW()),
       (3, '유엠씨', 'umc@gmail.com', '010-3333-3333', '2000-03-03', 'MALE', NOW(), NOW());


INSERT INTO review (id, content, rating, member_id, store_id, created_at, updated_at)
VALUES (1, '너무 좋아요!', 5.0, 1, 1, NOW(), NOW()),
       (2, '분위기 짱~', 3.0, 1, 2, NOW(), NOW()),
       (3, '서비스가 좋습니다', 4.8, 2, 2, NOW(), NOW()),
       (4, '음식이 맛있고 사장님이 친절해요', 4.5, 3, 3,NOW(), NOW());

INSERT INTO food_category (id, name, store_id, created_at, updated_at)
